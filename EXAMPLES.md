...
unset NODE_PREFIX MANAGER_COUNT WORKER_COUNT CLUSTER_TYPE CPUS_PER_NODE RAM_PER_NODE MANAGER_CPUS MANAGER_RAM WORKER_CPUS WORKER_RAM DISK_PER_NODE KUBECONFIG
